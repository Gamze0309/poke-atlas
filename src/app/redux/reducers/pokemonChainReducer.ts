...
export const fetchPokemonChainData = createAsyncThunk(
    ...
    async (pokemonName: string) => {
        ...
        const evolutionChain = parseEvolutionChain(pokemonChainResponse.data.chain);

        const pokemonDetailsPromises = evolutionChain.map(async (pokemonNameInChain: string) => {
